...
```{r}
include_graphics("../Output/figs/16S_Shannon_vs_plant_site.png")
...
readRDS("../Output/figs/16S_Ordination_Plots_Drought.RDS")
readRDS("../Output/figs/16S_Ordination_Plots_Site.RDS")
...
```{r}
readRDS("../Output/figs/ITS_Ordination_Plots_Host.RDS")
readRDS("../Output/figs/ITS_Ordination_Plots_Drought.RDS")
readRDS("../Output/figs/ITS_Ordination_Plots_Site.RDS")
...
```{r}
include_graphics("../Output/figs/16S_DiffAbund_Overview_host.png")
include_graphics("../Output/figs/16S_DiffAbund_Overview_fire.png")
include_graphics("../Output/figs/16S_DiffAbund_Overview_drought.png")

```

### **Relative Abundances in root samples**
...
```{r}
include_graphics("../Output/figs/ITS_DiffAbund_Overview_host.png")
include_graphics("../Output/figs/ITS_DiffAbund_Overview_fire.png")
include_graphics("../Output/figs/ITS_DiffAbund_Overview_drought.png")
```
