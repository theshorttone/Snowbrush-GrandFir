...
# File parsing - 
path <- "./Data/Raw/16S" # CHANGE to the directory containing your adaptor-free demultiplexed fastq files when using your own data
...
seqtab.nochim <- readRDS("./Output/16S_seqtab.nochim.RDS")
...
# add_species names
taxa <- addSpecies(taxa, "./Taxonomy/rdp_species_assignment_18.fa.gz",tryRC = TRUE,verbose = TRUE)
