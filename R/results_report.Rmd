...
```{r, fig.width=8,fig.height=6}
readRDS("../Output/figs/ITS_Ordination_Plots_Host.RDS") + theme(legend.position = 'bottom') + ggtitle("Fungal ordinations")
readRDS("../Output/figs/ITS_Ordination_Plots_Drought.RDS") + theme(legend.position = 'bottom') + ggtitle("Fungal ordinations")
readRDS("../Output/figs/ITS_Ordination_Plots_Site.RDS") + theme(legend.position = 'bottom') + ggtitle("Fungal ordinations")
