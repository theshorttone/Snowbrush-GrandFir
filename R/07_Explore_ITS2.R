...
## data ####
ps <- readRDS("./Output/phyloseq_objects/ITS_clean_phyloseq_object_w_guilds.RDS") 
inoc <- readRDS("./Output/phyloseq_objects/ITS_inoculum_samples_clean_phyloseq_object.RDS")
...
saveRDS(p,"./Output/figs/ITS_Shannon_vs_plant_drought.RDS")
p
ggsave("./Output/figs/ITS_Shannon_vs_plant_drought.png",height = 4,width = 10)
...
saveRDS(p,"./Output/figs/ITS_Shannon_vs_plant_burnfreq.RDS")
p
ggsave("./Output/figs/ITS_Shannon_vs_plant_burnfreq.png",height = 4,width = 10)
...
saveRDS(p,"./Output/figs/ITS_Shannon_vs_plant_site.RDS")
p
ggsave("./Output/figs/ITS_Shannon_vs_plant_site.png",height = 4,width = 10)
...
#   theme_minimal()
# p
# saveRDS(p,"./Output/figs/ITS_burn_frequency_and_alpha-div.RDS")
...
#   theme_minimal()
# p
# saveRDS(p,"./Output/figs/ITS_inoc_source_and_alpha-div.RDS")
...
permanova_results; saveRDS(permanova_results,"./Output/ITS_Permanova_Table.RDS")
...
saveRDS(gf_permanova_results,"./Output/ITS_Permanova_Table_gf-only.RDS")
...
saveRDS(sb_permanova_results,"./Output/ITS_Permanova_Table_sb-only.RDS")
...
saveRDS(rf_drought_mod,"./Output/ITS_RF_model_drought.RDS")
...
rf_fire_mod <- 
  ...
  ranger::ranger(formula = burned ~ .,
                 data=.,importance = 'permutation',num.trees = 999)
saveRDS(rf_fire_mod,"./Output/ITS_RF_model_fire.RDS")
...
rf_host_mod <- 
  ...
  ranger::ranger(formula = grandfir ~ .,
                 data=.,importance = 'permutation',num.trees = 999)
saveRDS(rf_host_mod,"./Output/ITS_RF_model_host.RDS")
...
ggsave("./Output/figs/ITS_VIP_Plot_drought.png",width = 8,height = 4)
...
ggsave("./Output/figs/ITS_VIP_Plot_fire.png",width = 8,height = 4)
...
ggsave("./Output/figs/ITS_VIP_Plot_host.png",width = 8,height = 4)
...
ps_genus_host_topten %>% 
  ...
  labs(fill="Host")
saveRDS(p,"./Output/figs/ITS_Important_Taxa_Abundances_host.RDS")
# ggsave("./Output/figs/ITS_Important_Taxa_Abundances_host.png",width = 8,height = 5)
p <- 
ps_genus_fire_topten %>% 
...
saveRDS(p,"./Output/figs/ITS_Important_Taxa_Abundances_fire.RDS")
# ggsave("./Output/figs/ITS_Important_Taxa_Abundances_fire.png",width = 8,height = 5)
...
ps_genus_drought_topten %>% 
  ...
  labs(fill="Drought")
saveRDS(p,"./Output/figs/ITS_Important_Taxa_Abundances_drought.RDS")
# ggsave("./Output/figs/ITS_Important_Taxa_Abundances_drought.png",width = 8,height = 5)
...
saveRDS(p3,"./Output/figs/ITS_heatmap_mostabund.RDS")
...
host_model_df %>%
  ...
  saveRDS(p,"./Output/figs/ITS_DiffAbund_Overview_host.RDS")
# ggsave("./Output/figs/ITS_DiffAbund_Overview_host.png",dpi=300,height = 4,width = 12)
...
fire_model_df %>%
  ...
  theme(strip.text = element_text(face='bold.italic',size=12),
        axis.text.y = element_text(face="bold.italic")) +
  scale_color_manual(values = "brown4")
  saveRDS(p,"./Output/figs/ITS_DiffAbund_Overview_fire.RDS")
# ggsave("./Output/figs/ITS_DiffAbund_Overview_fire.png",dpi=300,height = 4,width = 14)
...
bbdml_plot_1
bbdml_plot_2
saveRDS(bbdml_plot_1,"./Output/ITS_bbdml_plot_1.RDS")
saveRDS(bbdml_plot_2,"./Output/ITS_bbdml_plot_2.RDS")
