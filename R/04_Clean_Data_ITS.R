...
pos <- ps %>% 
  subset_samples(sample_names(ps) == "F-P-2")
...
ggsave("./Output/figs/ITS_Fungal_positive_control_taxonomy.png",height = 4,width = 6)


# Remove postive control
ps <- ps %>% subset_samples(sample_names(ps) != "F-P-2")
...
saveRDS(site1.inoc.full,"Output/phyloseq_objects/ITS_site1.inoc.full.RDS")
saveRDS(site2.inoc.full,"Output/phyloseq_objects/ITS_site2.inoc.full.RDS")
saveRDS(site3.inoc.full,"Output/phyloseq_objects/ITS_site3.inoc.full.RDS")
saveRDS(site4.inoc.full,"Output/phyloseq_objects/ITS_site4.inoc.full.RDS")
saveRDS(site5.inoc.full,"Output/phyloseq_objects/ITS_site5.inoc.full.RDS")
saveRDS(site6.inoc.full,"Output/phyloseq_objects/ITS_site6.inoc.full.RDS")
saveRDS(site1.inoc,"Output/phyloseq_objects/ITS_site1.inoc.RDS")
saveRDS(site2.inoc,"Output/phyloseq_objects/ITS_site2.inoc.RDS")
saveRDS(site3.inoc,"Output/phyloseq_objects/ITS_site3.inoc.RDS")
saveRDS(site4.inoc,"Output/phyloseq_objects/ITS_site4.inoc.RDS")
saveRDS(site5.inoc,"Output/phyloseq_objects/ITS_site5.inoc.RDS")
saveRDS(site6.inoc,"Output/phyloseq_objects/ITS_site6.inoc.RDS")
# full objects
saveRDS(ps, file = "./Output/phyloseq_objects/ITS_clean_phyloseq_object.RDS")
saveRDS(inoc, file = "./Output/phyloseq_objects/ITS_inoculum_samples_clean_phyloseq_object.RDS")
